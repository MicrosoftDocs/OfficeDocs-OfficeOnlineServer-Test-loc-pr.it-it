...
<p>Per valutare il funzionamento di server Office Web Apps, è possibile <a href="deploy-office-web-apps-server.md">distribuire una farm di server Office Web Apps a server singolo in un ambiente di testing</a> oppure, se si preferisce qualcosa di più sicuro <a href="deploy-office-web-apps-server.md">distribuire una farm di server Office Web Apps a server singolo che usa il protocollo HTTPS</a>. Se si devono supportare molti utenti, è possibile <a href="deploy-office-web-apps-server.md">distribuire una farm di server Office Web Apps con più server e bilanciamento del carico che usa il protocollo HTTPS</a>.</p>
<p><br />
</p>
